...
//
      ...
      if (m_use_EQL)
      {
        mMuOrig_EQL[g].define(ifirst,ilast,jfirst,jlast,kfirst,klast);
        ...
        // initialize values
        mMuOrig_EQL[g].set_to_minusOne();
        mEmax[g].set_to_minusOne();
        mQsOrig_EQL[g].set_to_minusOne();

        m_min_dist_to_srcs[g].set_to_zero();
        ...
        m_vsBins_EQL[0] = 250.0;
        m_vsBins_EQL[1] = 500.0;
        m_vsBins_EQL[2] = 750.0;
...
//
  for (int g = mNumberOfCartesianGrids; g <mNumberOfGrids; g++)
  {
    ...
    if (m_use_EQL)
    {
      mMuOrig_EQL[g].define(m_iStart[g],m_iEnd[g],m_jStart[g],m_jEnd[g],m_kStart[g],m_kEnd[g]);
